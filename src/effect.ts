import { Effect, Array, Option, pipe, Stream, Chunk, StreamEmit, Schema, ParseResult } from "effect";
import {
    FetchHttpClient,
    HttpClient,
    HttpClientResponse,
...
const getRequest = (url: string) =>
    pipe(
        ...
        Effect.andThen((client) => {
            const modifiedClient = HttpClient.withTracerPropagation(false)(client);
            return modifiedClient.get(url);
        }),
